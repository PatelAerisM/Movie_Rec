$(function() {
  // By default, button will be disabled until we type anything inside the input field
  ...
  $('.movie-button').on('click',function(){
    var my_api_key = '4e3cafab16adcdda969ca7df9ebad704';
    var title = $('.movie').val();
    if (title=="") {
...
// This function will be invoked  at the time of clicking on the recommended movies
...
// This is used to get the basic details of the movie from the API (based on the name of the movie)
...
// Here we are passing the movie name to get the similar movies from python's flask
...
// To get all the details of the movie using the movie id.
...
// We are passing all the details to python's flask for displaying and scraping the movie reviews using imdb id
...
// To get the details of individual cast
...
// For getting the details of the cast for the requested movie
...
// For getting posters for all the recommended movies
